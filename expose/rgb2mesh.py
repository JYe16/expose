...
def main(
    ...
    expose_dloader = preprocess_images(
        '../data/img_raw/' + image_folder + '/', exp_cfg, batch_size=rcnn_batch, device=device)
    ...
    mesh_mat_name = '../data/mat_mesh/' + image_folder + '.mat'
    scipy.io.savemat(mesh_mat_name, mdict={'data': mesh_points})
